...
"")
        ...
        self.opciones.setGeometry(QtCore.QRect(10, 180, 211, 181))
        ...
        self.recuperar_rutas.setGeometry(QtCore.QRect(10, 20, 191, 31))
        ...
        self.copiar = QtWidgets.QCheckBox(self.opciones)
        self.copiar.setGeometry(QtCore.QRect(10, 60, 191, 17))
        self.copiar.setObjectName("copiar")
        self.rutas = QtWidgets.QGroupBox(self.centralwidget)
        self.rutas.setGeometry(QtCore.QRect(10, 10, 611, 101))
        self.rutas.setTitle("")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.recuperar_rutas.setText(_translate("MainWindow", "RECUPERAR RUTAS(LOG)"))
